...
fileManagement::fileManagement() //QMake Constructor
{

}

//scope operator tells that the function belongs to the class on the left
void fileManagement::WriteFile(QString fileName, QVector<QString> fileContent){ //takes file name and vector of file content
...
bool fileManagement::CheckValidUser(QString userName, QString fileName) { // used to see if the username is in the file
...
QVector<QVector<QString>> fileManagement::ReadFile(QString fileName, int numCols) { //a vector of vectors of strings
